...
public class Setup extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final String loginUrl = "https://api.put.io/v2/oauth2/authenticate?client_id=1115&response_type=token&redirect_uri=http://www.idonthaveone.com/callback.php";
        ...
        public void onLoadResource(WebView view, String url) {
            if (url.contains("code=")) {
                ...
                final String finalUrl = new String(
                        "https://api.put.io/v2/oauth2/access_token?client_id=1115&client_secret=j3h257equegwoasnd80x&grant_type=authorization_code&redirect_uri=http://www.idonthaveone.com/callback.php&code="
                                + code);
...
//		});
    ...
    void saveTokenFromWeb(final String url) {
        ...
        JSONObject json;
        try {
            json = new JSONObject(Utils.convertStreamToString(getJsonData(url)));
